 ...
 <div class="car">
  <div class="content">
    <van-swipe-cell wx:if="{{carList.length}}"  bind:open="onOpen" id="swipe-cell2" right-width="{{ 89 }}" v-for="item in carOrderData" :key="item.detailId"  >
              <div class="item" >
                <div class="tops">
                  <div class="tops_left"><van-checkbox checked-color="#ff0000" name="213" v-model="item.checked" data-carId="{{item.carId}}" @change="onChangeCheck"></van-checkbox></div>
...
//切换多选按钮
const onChangeCheck = async(checked: boolean,value:any)=>{
