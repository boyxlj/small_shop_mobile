  ...
  <div class="item" v-for="(item,index) in orderData" :key="index" >
   ...
   <!--  <div class="title">{{item.title}}</div>-->
    ...
    <div class="btns">
      ...
      <van-button @click="pay(item.orderNumber)" size="small" data-orderNumber="{{item.orderNumber}}"   style="margin-left:20rpx;" v-if="item.type=='2'"  type="danger" round>立即支付</van-button>
    </div>
  </div>
