...
<script setup lang="ts">
  import {getSelectConfirmOrder,getDeleteOrder,getAllAddress} from "@/api/request"
...
onMounted(()=>{
  ...
  console.log("更新订单号：",orderNumber.value)
  getOrderDetail()
})

//查询订单详情
const getOrderDetail = async ()=>{
  const {data:res} = await getSelectConfirmOrder("1662211077909")
  console.log(res)
