<template>
  ...
  <div class="checkoutbox">
    <div class="content">
      <div class="address">
        <div wx:if="{{defaultAddress.length}}" class="top">
          <div class="left">
            <div class="img">
              <van-icon @click="showPopup" class="icons" name="map-marked" />
            </div>
          ...
          <div class="right">
            <van-icon @click="showPopup" class="iconss" name="arrow" />
          </div>
        </div>
        <div wx:if="{{!defaultAddress.length}}" class="top">
    ...
    <van-popup v-model:show="showPopup" position="bottom" custom-style="height: 90%;" bind:close="onClose" closeable>
      <div class="popup">
        <div class="contents">
