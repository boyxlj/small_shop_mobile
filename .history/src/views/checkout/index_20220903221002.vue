...
<van-dialog use-slot title="请扫码支付"  v-model:show="payDialogShow" show-cancel-button @close="cancelPay" @confirm="confirmPay" confirmButtonspan="我已支付" @cancel="cancelPay">
