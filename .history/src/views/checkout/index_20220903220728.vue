...
<van-dialog use-slot title="请扫码支付" v-show="payDialogShow" show-cancel-button bind:close="onClose" @confirm="confirmPay" confirmButtonspan="我已支付" bind:cancel="cancel">
