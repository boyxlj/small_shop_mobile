...
<van-dialog use-slot title="请扫码支付" v-show="payDialogShow" show-cancel-button bind:close="onClose" bind:confirm="queren" confirmButtonspan="我已支付" bind:cancel="cancel">
...
<script setup lang="ts">
  import {getSelectConfirmOrder,getDeleteOrder,getAllAddress,setDefaultAddress} from "@/api/request"
  import { Toast,Dialog } from "vant";
  import {ICarOrderData} from "@/types/order"
  import {IUserAddress} from "@/types/address"
  const route= useRoute()
const showPopup = ref(false)
const payDialogShow = ref(true)
