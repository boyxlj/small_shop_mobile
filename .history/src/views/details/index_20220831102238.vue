<template>
  ...
  <div class="info">
    ...
    <ShopItem :indexShopData="randomShopData"></ShopItem>
    {{state}}
    <h1>231</h1>
    <!-- <van-goods-action>
...
const resq = useGetRandomShop()
console.log("***************",toRefs(resq))
const {randomShopData,state} = toRefs(resq)
