...
import { getShopDetail, getShopSwiper,getIsCollect } from "@/api/request";
...
const isCollect =async ()=>{
  ...
  console.log("判断中")
  console.log(localStorage.getItem("userId"),route.query.detailId)
  const {data:res} = await getIsCollect(
    localStorage.getItem("userId") as any ,route.query.detailId as any
  )
