...
//设置订单的收货地址
export const setOrderAddress = (orderNumber:number,addressId:number,removeCarList:any[],type:string)=>Axios.post(`/user/setorderaddress`,{orderNumber,addressId,removeCarList,type})
